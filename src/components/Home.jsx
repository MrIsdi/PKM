  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div data-aos="fade-left" className="md:flex w-1/3 h-fit hidden border border-[rgba(255, 255, 255, 0.62)] bg-[#2d2d2d73] backdrop-blur-[10px] rounded-[20px] p-10">
          <img
            src={tomato}
            alt=""
            className="rounded-xl w-fit mx-auto hidden md:block"
          />
        </div>
      </section>
    </React.Fragment>
